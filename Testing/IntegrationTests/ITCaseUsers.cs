...
public class ITCaseUsers: IDisposable
{
    private ITFixture _fixture;

    public ITCaseUsers(ITFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    {
        // Act-Assert
        Assert.Throws<BL.UserNotFoundException>(()=> _fixture.Facade.GetUserById(1500));
    }
    ...
    public void TestUpdateUserUncorrect()
    {
        ...
        // Act-Assert
        Assert.Throws<BL.UserUpdateException>(()=> _fixture.Facade.UpdateUser(3, userUpd));
    }
    ...
    {
        // Act-Assert
        Assert.Throws<BL.UserBlockException>(()=> _fixture.Facade.BlockUser(1500));
    }
}